...
class PipelineConfig(BaseModel):
    """Committed pipeline defaults passed through one scanner execution."""
...
class FinancialMetric(BaseModel):
    ...
    variance_percentage: str | None = None


class CorporateAction(BaseModel):
    event_type: str
    dividend_per_share: str | None = None
    book_closure_start: str | None = None
    book_closure_end: str | None = None
